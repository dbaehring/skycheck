...
test('Service Worker cached alle neuen RC1-Module unter einer einzigen v33-Version', async () => {
    ...
    assert.match(source, /skycheck-static-v33/);
    assert.match(source, /skycheck-api-v33/);
